      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          <motion.div
            ...
            <motion.p className="my-8 text-sm  text-gray-500 dark:text-neutral-300">
            ...
            <motion.p className="my-8 text-sm italic text-gray-900 dark:text-neutral-300">
              {testimonials[active].saying.split(" ").map((word, index) => (
                <motion.span
                  key={index}
                  initial={{
                    filter: "blur(10px)",
